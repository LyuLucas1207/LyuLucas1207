...
import { buildStarMaterial } from '../material'
import type { StreamConfig } from './types'

export type { StreamConfig, StreamShaders } from './types'
...
export class Stream {
  ...
  private buildGeometry(pathIndex: number, config: StreamConfig) {
    ...
    const streamPool = [...config.colors.hover, ...config.colors.light, ...config.colors.primary]
